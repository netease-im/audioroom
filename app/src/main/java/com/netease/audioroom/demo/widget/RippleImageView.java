...
public class RippleImageView extends RelativeLayout {
    ...
    private void getAttributeSet(Context context, AttributeSet attrs) {
        ...
        Log.e("TAG", "show_spacing_time=" + show_spacing_time + "mm imageViewWidth=" + imageViewWidth + "px  imageViewHeigth=" + imageViewHeigth + "px");
        typedArray.recycle();
    }
    ...
    private AnimationSet initAnimationSet() {
        ...
        //透明度
        AlphaAnimation aa = new AlphaAnimation(1, 0.0f);
        aa.setDuration(show_spacing_time * SIZE);
